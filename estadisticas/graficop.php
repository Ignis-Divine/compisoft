...
<html>
    ...
    <nav class="navbar justify-content-end navbar-expand-lg navbar-dark bg-dark">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="../estadisticas/graficop.php">Paises</a></li>
        </ul>
...
$con = ("SELECT Pais,COUNT(Pais) AS TotalP FROM `Navegador` GROUP BY Pais");
